...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default=r"E:\JUFE\codes\Real-Time Sphere Sweeping Stereo from Multiview Fisheye Images\sphere-stereo\resources")
